...
public class Solution {
	...
	public static void main(String[] args) {
		...
		System.out.println("The expected parent is 5. The actual parent is " + ((CustomTree) list).getParent("11"));
		System.out.println("The expected parent is 6. The actual parent is " + ((CustomTree) list).getParent("14"));
		System.out.println("The expected parent is null. The actual parent is " + ((CustomTree) list).getParent("16"));
